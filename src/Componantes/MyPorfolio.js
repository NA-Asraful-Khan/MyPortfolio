...
const MyPorfolio = () => {
    return (
        <div className="bg-white-grey p-8">
            <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 gap-7 place-items-center'>
                <div className="card bg-white shadow-xl ">
                    ...
                    <div className="card-body items-center text-center">
                        <h2 className="card-title text-2xl">Automotive Parts Manufacturing</h2>
                ...
                <div className="card bg-white shadow-xl ">
                    ...
                    <div className="card-body items-center text-center">
                        <h2 className="card-title text-2xl">AutoMobile Inventories</h2>
                        <h3 className='text-xl'>Technology: React,React Router,Express JS, Node js, MongoDB, Firebase Authentication</h3>
                ...
                <div className="card bg-white shadow-xl ">
                    ...
                    <div className="card-body items-center text-center">
                        <h2 className="card-title text-2xl">ANGELS MAKEUP</h2>
                ...
                <div className="card bg-white shadow-xl ">
                    ...
                    <div className="card-body items-center text-center">
                        <h2 className="card-title text-2xl">My Photograpy</h2>
                        <h3 className='text-xl'>Technology: React,React Router,Firebase Authentication</h3>
